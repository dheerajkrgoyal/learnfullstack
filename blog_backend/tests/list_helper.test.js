...
describe('most blog', () => {
    ...
    test('array has many blogs', () => {
        assert.deepStrictEqual(list_helper.mostBlogs(blogs), {author: 'Robert C. Martin', blogs: 3})
    })
})
...
describe('most likes', () => {
    ...
    test('array has many blogs', () => {
        assert.deepStrictEqual(list_helper.mostLikes(blogs), {author: 'Edsger W. Dijkstra', likes: 17})
    })
})